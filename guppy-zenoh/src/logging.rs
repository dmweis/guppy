...
const TRACING_FULL: &str = "guppy/tracing/full";
const TRACING_JSON: &str = "guppy/tracing/json";
...
pub fn setup_tracing(verbosity_level: u8) {
    ...
    let zenoh_full_writer = start_log_writer(TRACING_FULL);
    ...
    let zenoh_json_writer = start_log_writer(TRACING_JSON);
